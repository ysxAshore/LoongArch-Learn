...
HD_PWD='/home/ysxashore/Data_DISK/Projects/Studying/LoongArch-Learn/CPU_design/cdp_ede_local_LA_readygo/mycpu_env/soc_verify/soc_hs_bram/run_vivado/project/loongson.runs/data_ram_synth_1'
cd "$HD_PWD"
