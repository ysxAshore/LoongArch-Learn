...
HD_PWD='/home/ysxashore/Data_DISK/Projects/Studying/LoongArch-Learn/CPU_design/cdp_ede_local_LA_readygo/mycpu_env/soc_verify/soc_axi/run_vivado/project/loongson.runs/inst_tagv_way1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inst_tagv_way1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inst_tagv_way1.tcl
