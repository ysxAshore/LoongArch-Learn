...
#
# Script generated by Vivado on Mon Mar 11 12:29:36 CST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : inst_tagv_way0.sh
...
#
# Usage        : inst_tagv_way0.sh
#                inst_tagv_way0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                inst_tagv_way0.sh [-reset_run]
#                inst_tagv_way0.sh [-reset_log]
#                inst_tagv_way0.sh [-help]
#
...
#                script (type 'inst_tagv_way0.sh -help' for more information).
#
...
# script info
echo -e "inst_tagv_way0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./inst_tagv_way0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.inst_tagv_way0 xil_defaultlib.glbl -o inst_tagv_way0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./inst_tagv_way0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key inst_tagv_way0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc inst_tagv_way0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./inst_tagv_way0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: inst_tagv_way0.sh [-help]\n\
Usage: inst_tagv_way0.sh [-step]\n\
Usage: inst_tagv_way0.sh [-lib_map_path]\n\
Usage: inst_tagv_way0.sh [-reset_run]\n\
Usage: inst_tagv_way0.sh [-reset_log]\n\
Usage: inst_tagv_way0.sh [-keep_index]\n\
Usage: inst_tagv_way0.sh [-noclean_files]\n\n\
