...
#
# Script generated by Vivado on Thu Apr 11 21:16:07 +0800 2024
...
# script info
echo -e "data_bank_sram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_bank_sram xil_defaultlib.data_bank_sram xil_defaultlib.glbl -log elaborate.log
}
