...
#
# Script generated by Vivado on Sun Mar 10 14:10:31 CST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : data_way0_bank2.sh
...
#
# Usage        : data_way0_bank2.sh
#                data_way0_bank2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                data_way0_bank2.sh [-reset_run]
#                data_way0_bank2.sh [-reset_log]
#                data_way0_bank2.sh [-help]
#
...
#                script (type 'data_way0_bank2.sh -help' for more information).
#
...
# script info
echo -e "data_way0_bank2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./data_way0_bank2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.data_way0_bank2 xil_defaultlib.glbl -o data_way0_bank2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./data_way0_bank2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key data_way0_bank2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc data_way0_bank2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./data_way0_bank2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: data_way0_bank2.sh [-help]\n\
Usage: data_way0_bank2.sh [-step]\n\
Usage: data_way0_bank2.sh [-lib_map_path]\n\
Usage: data_way0_bank2.sh [-reset_run]\n\
Usage: data_way0_bank2.sh [-reset_log]\n\
Usage: data_way0_bank2.sh [-keep_index]\n\
Usage: data_way0_bank2.sh [-noclean_files]\n\n\
