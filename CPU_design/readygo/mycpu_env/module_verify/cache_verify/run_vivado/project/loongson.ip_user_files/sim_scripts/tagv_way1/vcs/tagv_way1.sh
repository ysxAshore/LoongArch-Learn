...
#
# Script generated by Vivado on Sun Mar 10 14:13:48 CST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : tagv_way1.sh
...
#
# Usage        : tagv_way1.sh
#                tagv_way1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tagv_way1.sh [-reset_run]
#                tagv_way1.sh [-reset_log]
#                tagv_way1.sh [-help]
#
...
#                script (type 'tagv_way1.sh -help' for more information).
#
...
# script info
echo -e "tagv_way1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tagv_way1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tagv_way1 xil_defaultlib.glbl -o tagv_way1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tagv_way1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tagv_way1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tagv_way1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tagv_way1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tagv_way1.sh [-help]\n\
Usage: tagv_way1.sh [-step]\n\
Usage: tagv_way1.sh [-lib_map_path]\n\
Usage: tagv_way1.sh [-reset_run]\n\
Usage: tagv_way1.sh [-reset_log]\n\
Usage: tagv_way1.sh [-keep_index]\n\
Usage: tagv_way1.sh [-noclean_files]\n\n\
