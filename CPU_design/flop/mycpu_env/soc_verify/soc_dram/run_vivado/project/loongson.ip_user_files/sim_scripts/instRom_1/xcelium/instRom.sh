...
#
# Script generated by Vivado on Thu Dec 21 10:32:55 CST 2023
...
#
# Usage        : instRom.sh
#                instRom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instRom.sh [-reset_run]
#                instRom.sh [-reset_log]
#                instRom.sh [-help]
#
...
#                script (type 'instRom.sh -help' for more information).
#
...
# script info
echo -e "instRom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instRom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.instRom xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.instRom -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log instRom_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: instRom.sh [-step]\n\
Usage: instRom.sh [-lib_map_path]\n\
Usage: instRom.sh [-reset_run]\n\
Usage: instRom.sh [-reset_log]\n\
Usage: instRom.sh [-keep_index]\n\
