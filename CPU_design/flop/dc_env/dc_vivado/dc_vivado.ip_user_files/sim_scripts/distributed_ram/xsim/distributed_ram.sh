...
#
# Script generated by Vivado on Sat Dec 16 18:21:42 CST 2023
...
# script info
echo -e "distributed_ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot distributed_ram xil_defaultlib.distributed_ram xil_defaultlib.glbl -log elaborate.log
}
