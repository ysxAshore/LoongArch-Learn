...
> 参考资料
>
> [4 特权资源架构概述](<../../LA32R 指令集学习指导手册/4 特权资源架构概述/4 特权资源架构概述.md> "4 特权资源架构概述")
>
> [6 例外与中断](<../../LA32R 指令集学习指导手册/6 例外与中断/6 例外与中断.md> "6 例外与中断")
>
> [7 控制状态寄存器CSR](<../../LA32R 指令集学习指导手册/7 控制状态寄存器CSR/7 控制状态寄存器CSR.md> "7 控制状态寄存器CSR")
