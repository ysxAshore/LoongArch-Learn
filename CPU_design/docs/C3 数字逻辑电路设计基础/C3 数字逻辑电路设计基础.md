...
![](image/image_L_NgzxGHVY.png)

![](image/image_GxQatBBGkX.png)
...
![](image/image_DScSSv_b_X.png)

上图是异步RAM的仿真，观察可以得到**异步RAM写RAM需要时钟上升沿的控制，但是读RAM是只需要读地址改变即可。而同步RAM的读和写均需要时钟信号的控制**

#### 2.2.2 时序结果和资源利用率

![](image/image_y1rdCZzNOZ.png)

![](image/image_y8ml4BiMqF.png)
...
2. 执行忽视该错误的TCL命令
   ...
   ![](image/image_Ng0XC56vHS.png)

   在下图的Bitstream→tcl.pre添加刚刚新建的tcl文件

   ![](image/image__ENGlfdlLt.png)
