...
HD_PWD='/home/ysxashore/Data_DISK/Projects/Studying/LoongArch-Learn/CPU_design/cdp_ede_local/dc_env/dc_vivado/dc_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log show_sw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source show_sw.tcl
