...
#
# Script generated by Vivado on Wed Dec 20 21:16:20 CST 2023
...
#
# Usage        : inst_rom.sh
#                inst_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                inst_rom.sh [-reset_run]
#                inst_rom.sh [-reset_log]
#                inst_rom.sh [-help]
#
...
#                script (type 'inst_rom.sh -help' for more information).
#
...
# script info
echo -e "inst_rom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./inst_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.inst_rom xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.inst_rom -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ysxashore/Data_DISK/Projects/Studying/LoongArch-Learn/CPU_design/cdp_ede_local/mycpu_env/soc_verify/soc_dram/run_vivado/project/loongson.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log inst_rom_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: inst_rom.sh [-step]\n\
Usage: inst_rom.sh [-lib_map_path]\n\
Usage: inst_rom.sh [-reset_run]\n\
Usage: inst_rom.sh [-reset_log]\n\
Usage: inst_rom.sh [-keep_index]\n\
