...
HD_PWD='/home/ysxashore/Data_DISK/Projects/Studying/LoongArch-Learn/CPU_design/cdp_ede_local/minicpu_env/soc_verify/run_vivado/project/loongson.runs/synth_1'
cd "$HD_PWD"
