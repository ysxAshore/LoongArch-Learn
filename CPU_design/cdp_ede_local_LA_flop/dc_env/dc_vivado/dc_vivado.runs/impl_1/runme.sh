...
HD_PWD='/home/ysxashore/Data_DISK/Projects/Studying/LoongArch-Learn/CPU_design/cdp_ede_local/dc_env/dc_vivado/dc_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log show_sw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source show_sw.tcl -notrace
