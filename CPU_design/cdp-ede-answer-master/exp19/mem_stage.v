...
assign csr_crmd  ={27'd0,csr_crmd_pg,csr_crmd_da,csr_crmd_ie,csr_crmd_plv};
...
assign refetch         =(ms_tlbrd|ms_tlbwr|ms_tlbfill|ms_invtlb|((ms_csrwr|ms_csrxchg)&&(ms_csr_num==`CSR_ASID|ms_csr_num==`CSR_TLBEHI|ms_csr_num==`CSR_DMW0|
