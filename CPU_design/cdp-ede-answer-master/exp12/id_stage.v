...
wire[31:0] csr_mask;
wire[13:0] csr_num;
assign exl     =inst_syscall;
assign ecode   =inst_syscall? 6'h0b:6'h00;
assign esubcode=9'h00;
assign csr_mask=rj_value;
assign csr_num =ds_inst[23:10];

assign ds_to_es_bus = {inst_csrrd  ,
                       inst_csrwr  ,
					   inst_csrxchg,
					   inst_ertn   ,
					   exl         ,
...
assign no_rk=inst_slli_w|inst_srli_w|inst_srai_w|inst_addi_w|inst_ld_w|inst_st_w|inst_jirl|inst_b|inst_bl|inst_beq|inst_bne|inst_lu12i_w|inst_slti|inst_sltui|inst_andi|
			 ...
			 inst_csrwr|inst_csrxchg|inst_syscall|inst_ertn;
assign no_rd=inst_add_w|inst_addi_w|inst_sub_w|inst_ld_w|inst_b|inst_bl|inst_jirl|inst_slt|inst_sltu|inst_slli_w|inst_srli_w|inst_srai_w|inst_lu12i_w|inst_and|inst_or
			 ...
			 |inst_mod_wu|inst_ld_b|inst_ld_h|inst_ld_bu|inst_ld_hu|inst_csrrd|inst_syscall|inst_ertn;
assign no_dest=inst_b|inst_beq|inst_bne|inst_st_w|inst_blt|inst_bltu|inst_bge|inst_bgeu|inst_st_b|inst_st_h|inst_syscall|inst_ertn;
...
assign load_op       = inst_ld_w | inst_ld_b | inst_ld_h | inst_ld_bu | inst_ld_hu | inst_csrrd|inst_csrwr|inst_csrxchg;
...
assign rj_lt_rd_u=~compare_cout;
