...
assign data_sram_en    = (es_res_from_mem || es_mem_we) && es_valid && ~ms_to_es_reflush;
assign data_sram_wen   = es_mem_we && es_valid ?( es_st_b? ((es_alu_result[1:0]==2'b00)? 4'b0001:
