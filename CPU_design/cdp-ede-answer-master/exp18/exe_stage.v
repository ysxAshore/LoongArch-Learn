...
assign es_to_ms_bus = {es_tlbsrch     ,
                       es_tlbrd       ,
                       es_tlbwr       ,
					   es_tlbfill     ,
					   es_invtlb      ,
...
assign s1_vppn     =es_tlbsrch && ~ms_to_es_reflush? ms_to_es_vppn:es_rkd_value[31:13];
assign s1_asid     =es_tlbsrch && ~ms_to_es_reflush? ms_to_es_asid:es_rj_value[9:0];
assign s1_va_bit12 =es_tlbsrch && ~ms_to_es_reflush? 1'b1:1'b0;
