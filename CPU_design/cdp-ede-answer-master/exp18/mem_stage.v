...
assign csr_rvalue={32{ms_csr_num==`CSR_CRMD}}&csr_crmd | {32{ms_csr_num==`CSR_PRMD}}&csr_prmd | {32{ms_csr_num==`CSR_ESTAT}}&csr_estat | {32{ms_csr_num==`CSR_ERA}}&csr_era|
				  ...
				  {32{ms_csr_num==`CSR_ASID}}&csr_asid | {32{ms_csr_num==`CSR_TLBRENTRY}}&csr_tlbrentry; 
...
assign refetch         =(ms_tlbrd|ms_tlbwr|ms_tlbfill|ms_invtlb|((ms_csrwr|ms_csrxchg)&&(ms_csr_num==`CSR_ASID|ms_csr_num==`CSR_TLBEHI)))&ms_valid;
