...
wire[4:0]   mode;
assign mode=ds_inst[4:0];

assign ds_to_es_bus = {inst_cacop  ,
                       mode        ,
...
assign no_rk=inst_slli_w|inst_srli_w|inst_srai_w|inst_addi_w|inst_ld_w|inst_st_w|inst_jirl|inst_b|inst_bl|inst_beq|inst_bne|inst_lu12i_w|inst_slti|inst_sltui|inst_andi|
			 ...
			 inst_csrwr|inst_csrxchg|inst_syscall|inst_ertn|inst_break|inst_rdcntid_w|inst_rdcntvh_w|inst_rdcntvl_w|inst_ine|inst_tlbsrch|inst_tlbrd|inst_tlbwr|inst_tlbfill|inst_cacop;
assign no_rd=inst_add_w|inst_addi_w|inst_sub_w|inst_ld_w|inst_b|inst_bl|inst_jirl|inst_slt|inst_sltu|inst_slli_w|inst_srli_w|inst_srai_w|inst_lu12i_w|inst_and|inst_or
			 ...
			 |inst_mod_wu|inst_ld_b|inst_ld_h|inst_ld_bu|inst_ld_hu|inst_csrrd|inst_syscall|inst_ertn|inst_break|inst_rdcntvh_w|inst_rdcntvl_w|inst_ine|inst_invtlb|inst_cacop;
assign no_dest=inst_b|inst_beq|inst_bne|inst_st_w|inst_blt|inst_bltu|inst_bge|inst_bgeu|inst_st_b|inst_st_h|inst_syscall|inst_ertn|inst_break|inst_ine|inst_tlbsrch|inst_tlbrd|
               inst_tlbwr|inst_tlbfill|inst_invtlb|inst_cacop;
...
assign br_cancel=br_taken && ds_ready_go && es_allowin;
...
assign inst_ine    = ~inst_add_w&~inst_sub_w&~inst_slt&~inst_sltu&~inst_nor&~inst_and&~inst_or&~inst_xor&~inst_slli_w&~inst_srli_w&~inst_srai_w&~inst_addi_w&~inst_ld_w&~inst_st_w&
					 ...
					 ~inst_rdcntvh_w&~inst_rdcntvl_w&~inst_tlbsrch&~inst_tlbrd&~inst_tlbwr&~inst_tlbfill&~inst_invtlb&~inst_cacop;
...
assign need_si12  =  inst_addi_w | inst_ld_w | inst_st_w | inst_slti | inst_sltui|inst_ld_b|inst_ld_h|inst_ld_bu|inst_ld_hu|inst_st_b|inst_st_h|inst_cacop;
...
assign src2_is_imm   = inst_slli_w | inst_srli_w | inst_srai_w | inst_addi_w | inst_ld_w | inst_st_w | inst_lu12i_w | inst_jirl | inst_bl |
					   inst_slti | inst_sltui  | inst_andi | inst_ori | inst_xori | inst_pcaddu12i | inst_ld_b | inst_ld_h | inst_ld_bu | inst_ld_hu | inst_st_b | inst_st_h | inst_cacop;
