...
wire[31:0] csr_mask;
wire[13:0] csr_num;
assign exl     =inst_syscall | inst_break | inst_ine | ds_adef | has_int;
...
assign ds_to_es_bus = {inst_rdcntvh_w,
                       inst_rdcntvl_w,
					   inst_rdcntid_w,
...
assign no_rk=inst_slli_w|inst_srli_w|inst_srai_w|inst_addi_w|inst_ld_w|inst_st_w|inst_jirl|inst_b|inst_bl|inst_beq|inst_bne|inst_lu12i_w|inst_slti|inst_sltui|inst_andi|
			 ...
			 inst_csrwr|inst_csrxchg|inst_syscall|inst_ertn|inst_break|inst_rdcntid_w|inst_rdcntvh_w|inst_rdcntvl_w|inst_ine;
assign no_rd=inst_add_w|inst_addi_w|inst_sub_w|inst_ld_w|inst_b|inst_bl|inst_jirl|inst_slt|inst_sltu|inst_slli_w|inst_srli_w|inst_srai_w|inst_lu12i_w|inst_and|inst_or
			 ...
			 |inst_mod_wu|inst_ld_b|inst_ld_h|inst_ld_bu|inst_ld_hu|inst_csrrd|inst_syscall|inst_ertn|inst_break|inst_rdcntvh_w|inst_rdcntvl_w|inst_ine;
assign no_dest=inst_b|inst_beq|inst_bne|inst_st_w|inst_blt|inst_bltu|inst_bge|inst_bgeu|inst_st_b|inst_st_h|inst_syscall|inst_ertn|inst_break|inst_ine;
...
assign load_stall=((rj_equal && (rj==es_to_ds_dest) && es_load_op) || (rk_equal && ~src_reg_is_rd && (rk==es_to_ds_dest) && es_load_op) || 
                  (rd_equal && src_reg_is_rd && (rd==es_to_ds_dest) && es_load_op))&&~ms_to_ds_reflush;

wire csr_stall;
assign csr_stall=(inst_csrrd | inst_csrwr | inst_csrxchg)&(csr_num==es_to_ds_num)&~ms_to_ds_reflush;

assign ds_ready_go    = ~load_stall & ~csr_stall;
