...
wire[31:0] fs_eentry;
wire[31:0] fs_era;
assign{fs_exl,fs_ertn,fs_eentry,fs_era}=ms_to_fs_bus_r_valid? ms_to_fs_bus_r : 
                                                              ms_to_fs_bus;
// pre-IF stage
wire pre_ready_go;
...
wire fs_reflush;
assign fs_reflush=ms_to_fs_bus[65]|ms_to_fs_bus[64];
wire fs_reflush_r;
assign fs_reflush_r=fs_exl | fs_ertn;
...
always@(posedge clk)begin
  ...
  else if(~ms_to_fs_bus_r_valid && (ms_to_fs_bus[65] | ms_to_fs_bus[64]) && ~pre_ready_go)begin
