...
#
# Script generated by Vivado on Sun May 05 21:03:47 +0800 2024
...
#
# Usage        : sram_128x22.sh
#                sram_128x22.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_128x22.sh [-reset_run]
#                sram_128x22.sh [-reset_log]
#                sram_128x22.sh [-help]
#
...
# script info
echo -e "sram_128x22.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_128x22.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sram_128x22 xil_defaultlib.sram_128x22 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sram_128x22.wdb xsim.dir libdpi.so)
...
Usage: sram_128x22.sh [-step]\n\
Usage: sram_128x22.sh [-lib_map_path]\n\
Usage: sram_128x22.sh [-reset_run]\n\
Usage: sram_128x22.sh [-reset_log]\n\
Usage: sram_128x22.sh [-keep_index]\n\
