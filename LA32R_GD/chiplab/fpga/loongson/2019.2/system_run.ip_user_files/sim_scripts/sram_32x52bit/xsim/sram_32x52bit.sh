...
#
# Script generated by Vivado on Sun May 05 21:03:56 +0800 2024
...
#
# Usage        : sram_32x52bit.sh
#                sram_32x52bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_32x52bit.sh [-reset_run]
#                sram_32x52bit.sh [-reset_log]
#                sram_32x52bit.sh [-help]
#
...
# script info
echo -e "sram_32x52bit.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_32x52bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sram_32x52bit xil_defaultlib.sram_32x52bit xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sram_32x52bit.wdb xsim.dir libdpi.so)
...
Usage: sram_32x52bit.sh [-step]\n\
Usage: sram_32x52bit.sh [-lib_map_path]\n\
Usage: sram_32x52bit.sh [-reset_run]\n\
Usage: sram_32x52bit.sh [-reset_log]\n\
Usage: sram_32x52bit.sh [-keep_index]\n\
