...
#
# Script generated by Vivado on Sun May 05 21:03:36 +0800 2024
...
#
# Usage        : axi_interconnect_0.sh
#                axi_interconnect_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_interconnect_0.sh [-reset_run]
#                axi_interconnect_0.sh [-reset_log]
#                axi_interconnect_0.sh [-help]
#
...
#                script (type 'axi_interconnect_0.sh -help' for more information).
#
...
# script info
echo -e "axi_interconnect_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_interconnect_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_interconnect_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_interconnect_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_interconnect_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axi_interconnect_0.sh [-step]\n\
Usage: axi_interconnect_0.sh [-lib_map_path]\n\
Usage: axi_interconnect_0.sh [-reset_run]\n\
Usage: axi_interconnect_0.sh [-reset_log]\n\
Usage: axi_interconnect_0.sh [-keep_index]\n\
