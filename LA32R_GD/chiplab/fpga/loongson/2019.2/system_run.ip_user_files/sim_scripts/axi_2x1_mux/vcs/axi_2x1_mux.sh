...
design_libs=(xpm fifo_generator_v13_2_8 axi_interconnect_v1_7_21 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axi_interconnect_v1_7_21 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_2x1_mux xil_defaultlib.glbl -o axi_2x1_mux_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_2x1_mux_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_2x1_mux_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_2x1_mux_simv.daidir vcs_lib c.obj)
