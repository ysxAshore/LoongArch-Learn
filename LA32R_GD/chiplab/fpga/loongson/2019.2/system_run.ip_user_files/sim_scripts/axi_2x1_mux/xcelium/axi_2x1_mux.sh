...
#
# Script generated by Vivado on Sun May 05 21:03:28 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : axi_2x1_mux.sh
...
#
# Usage        : axi_2x1_mux.sh
#                axi_2x1_mux.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_2x1_mux.sh [-reset_run]
#                axi_2x1_mux.sh [-reset_log]
#                axi_2x1_mux.sh [-help]
#
...
#                script (type 'axi_2x1_mux.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_8 -libname axi_interconnect_v1_7_21 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_8 axi_interconnect_v1_7_21 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_2x1_mux.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_2x1_mux.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axi_interconnect_v1_7_21 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_2x1_mux xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_2x1_mux -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_2x1_mux_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_2x1_mux.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_2x1_mux.sh [-help]\n\
Usage: axi_2x1_mux.sh [-step]\n\
Usage: axi_2x1_mux.sh [-lib_map_path]\n\
Usage: axi_2x1_mux.sh [-reset_run]\n\
Usage: axi_2x1_mux.sh [-reset_log]\n\
Usage: axi_2x1_mux.sh [-keep_index]\n\
Usage: axi_2x1_mux.sh [-noclean_files]\n\n\
