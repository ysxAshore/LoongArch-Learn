...
design_libs=(xpm axi_infrastructure_v1_1_0 fifo_generator_v13_2_8 axi_clock_converter_v2_1_27 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axi_clock_converter_v2_1_27 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
