...
#
# Script generated by Vivado on Thu May 16 20:55:13 +0800 2024
...
#
# Usage        : clk_pll_33.sh
#                clk_pll_33.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_pll_33.sh [-reset_run]
#                clk_pll_33.sh [-reset_log]
#                clk_pll_33.sh [-help]
#
...
# script info
echo -e "clk_pll_33.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_pll_33.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_pll_33 xil_defaultlib.clk_pll_33 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_pll_33.wdb xsim.dir libdpi.so)
...
Usage: clk_pll_33.sh [-step]\n\
Usage: clk_pll_33.sh [-lib_map_path]\n\
Usage: clk_pll_33.sh [-reset_run]\n\
Usage: clk_pll_33.sh [-reset_log]\n\
Usage: clk_pll_33.sh [-keep_index]\n\
